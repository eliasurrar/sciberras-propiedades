...
- **Sitio en vivo:** https://eliasurrar.github.io/sciberras-propiedades/
- **Spec del agente:** [`AGENTS.md`](./AGENTS.md)
- **Scripts:** `scripts/publish.py`, `scripts/unpublish.py`, `scripts/inspect.py`
- **Fuente de datos:** `site/data/listings.json`
